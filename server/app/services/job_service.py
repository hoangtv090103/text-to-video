...
class JobStore:
    ...
    async def save_job(self, job_id: str, status: str, message: Optional[str], progress: Optional[int], metadata: Optional[Dict[str, Any]] = None) -> None:
    ...
    async def update_job_status(self, job_id: str, status: str, message: Optional[str], progress: Optional[int]) -> None:
        async with self._lock:
...
class JobService:
    ...
    async def initialize_job(self, job_id: str, message: Optional[str] = None, progress: Optional[int] = None, **metadata: Any) -> None:
        await self.store.save_job(job_id, status="pending", message=message, progress=progress, metadata=metadata)

    async def set_job_status(self, job_id: str, status: str, message: Optional[str] = None, progress: Optional[int] = None) -> None:
